        ...
        <div className="py-16 border-b border-black/6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="md:col-span-1">
              <img src="/kld-logo-web.png" alt="KLD Stone" className="w-[120px] mb-6 opacity-90" />
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 text-[13px] text-[#111111]/45">
                <p className="flex items-center gap-2 text-[#34c759] font-medium">
                  ...
                  <a href="tel:+8615659069988" onClick={() => trackConversion("phone_click", {source:"footer"})}>+86 156 5906 9988</a>
                </p>
                ...
                <p className="flex items-center gap-2">
                  ...
                  <a href="https://wa.me/8615659069988" target="_blank" rel="noopener noreferrer" onClick={() => trackConversion("whatsapp_click", {source:"footer"})} className="hover:text-[#34c759] transition-colors">
